...
public class LevelThreeFragment extends Fragment {
    ...
    int[] angleArrayAnswer = {180, 270, 270, 180, 180, 0, 90, 270, 180, 270, 270, 0, 90, 0, 90, 0};
    int[] angleArrayBegin = {180, 90, 90, 180, 0, 90, 90, 90, 0, 0, 0, 180, 270, 0, 0, 0};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_level_three, container, false);
...
/*        Toast toast = Toast.makeText(getApplicationContext(),
        ...
        if (allTrue) {
            ...
            h.postDelayed(new Runnable() {
                @Override
                public void run() {
                    getActivity().getSupportFragmentManager().beginTransaction().remove(LevelThreeFragment.this).commit();
                    //ПОБЕДА!!!!!!!!!!
